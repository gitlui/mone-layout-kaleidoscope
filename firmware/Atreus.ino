...
void setup() {
  QUKEYS(
    // Second layer longpresses for some more seldomly used keys in the german language
    kaleidoscope::plugin::Qukey(1, KeyAddr(0, 0), RALT(Key_Q)),     // @
    kaleidoscope::plugin::Qukey(1, KeyAddr(1, 0), Key_Quote),       // ä
    kaleidoscope::plugin::Qukey(1, KeyAddr(1, 2), Key_Minus),       // ß
    kaleidoscope::plugin::Qukey(1, KeyAddr(0, 9), Key_LeftBracket), // ü
    kaleidoscope::plugin::Qukey(1, KeyAddr(1, 11), Key_Semicolon),  // ö
    kaleidoscope::plugin::Qukey(1, KeyAddr(1, 9), RALT(Key_E)),     // €
  )
